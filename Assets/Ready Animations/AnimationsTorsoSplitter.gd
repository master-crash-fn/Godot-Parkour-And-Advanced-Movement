...
var animations : Array = [
	preload("res://Assets/Ready Animations/ledge_left_ROOT_PINNED.res"),
	#preload("res://Assets/Ready Animations/mixamo_legs_animations/ledge_left_legs.res")
]

func _run():
	var scene = skeleton_donor_scene.instantiate()
	var skeleton = scene.get_node("GeneralSkeleton") as Skeleton3D#as MixamoSkeleton
	...
	for animation in animations:
		...
		print("here")
		ResourceSaver.save(torso_and_legs[1], "res://Assets/Ready Animations/ledge_left_legs_rootpinned" + "_legs.res")
